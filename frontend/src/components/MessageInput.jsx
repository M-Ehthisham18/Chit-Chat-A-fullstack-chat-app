...
import { Image, Send, X, Ban } from "lucide-react";
...
const MessageInput = () => {
  ...
  return (
    <div className="p-4 w-full">
      ...
      {isBlocked ? (
        <div className="flex items-center justify-center gap-2 p-3 bg-base-200 rounded-lg text-base-content/60 text-sm italic">
          <Ban size={16} />
          <span>
